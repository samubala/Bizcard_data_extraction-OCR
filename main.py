...
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | Samundeeswari Bala",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app was invented by RAY KURZWEIL IN 1970**!"""})
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        def save_card(uploaded_card):
            with open(os.path.join(r"C:\Users\samub\pythonProject3-Bizcarda-data-extraction\uploaded_card_img", uploaded_card.name), "wb") as f:
        ...
        with col2:
            ...
            with st.spinner("Please wait processing image..."):
                ...
                saved_img =os.path.join(r"C:\Users\samub\pythonProject3-Bizcarda-data-extraction\uploaded_card_img", uploaded_card.name)
